# Parsing Live CSTV Broadcasts (aka. CSTV+)

This example shows how to parse live [CSTV broadcasts](https://developer.valvesoftware.com/wiki/Counter-Strike:_Global_Offensive_Broadcast).
