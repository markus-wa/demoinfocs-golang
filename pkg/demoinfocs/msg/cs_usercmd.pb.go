...
const file_cs_usercmd_proto_rawDesc = "" +
	"\n" +
	"\x10cs_usercmd.proto\x1a\x15valveextensions.proto\x1a\x16networkbasetypes.proto\x1a\rusercmd.proto\"t\n" +
	...
	"\x04frac\x18\x03 \x01(\x02:\x010R\x04frac:\x04\xc0\xe4\x1d\x01\"\xb5\x06\n" +
	"\x17CSGOInputHistoryEntryPB\x12,\n" +
	"\vview_angles\x18\x02 \x01(\v2\v.CMsgQAngleR\n" +
	"viewAngles\x12*\n" +
	...
	"\x14player_tick_fraction\x18\a \x01(\x02R\x12playerTickFraction\x128\n" +
	"\tcl_interp\x18\f \x01(\v2\x1b.CSGOInterpolationInfoPB_CLR\bclInterp\x127\n" +
	"\n" +
	"sv_interp0\x18\r \x01(\v2\x18.CSGOInterpolationInfoPBR\tsvInterp0\x127\n" +
	"\n" +
	"sv_interp1\x18\x0e \x01(\v2\x18.CSGOInterpolationInfoPBR\tsvInterp1\x12=\n" +
	"\rplayer_interp\x18\x0f \x01(\v2\x18.CSGOInterpolationInfoPBR\fplayerInterp\x12!\n" +
	"\fframe_number\x18@ \x01(\x05R\vframeNumber\x12,\n" +
	"\x10target_ent_index\x18A \x01(\x05:\x02-1R\x0etargetEntIndex\x122\n" +
	"\x0eshoot_position\x18B \x01(\v2\v.CMsgVectorR\rshootPosition\x12>\n" +
	"\x15target_head_pos_check\x18C \x01(\v2\v.CMsgVectorR\x12targetHeadPosCheck\x12<\n" +
	"\x14target_abs_pos_check\x18D \x01(\v2\v.CMsgVectorR\x11targetAbsPosCheck\x12<\n" +
	"\x14target_abs_ang_check\x18E \x01(\v2\v.CMsgQAngleR\x11targetAbsAngCheck:\x04\xc0\xe4\x1d\x01\"\xfe\x03\n" +
	"\rCSGOUserCmdPB\x12#\n" +
	"\x04base\x18\x01 \x01(\v2\x0f.CBaseUserCmdPBR\x04base\x12=\n" +
	"\rinput_history\x18\x02 \x03(\v2\x18.CSGOInputHistoryEntryPBR\finputHistory\x12A\n" +
...
var (
	...
	file_cs_usercmd_proto_rawDescData []byte
)

func file_cs_usercmd_proto_rawDescGZIP() []byte {
	file_cs_usercmd_proto_rawDescOnce.Do(func() {
		file_cs_usercmd_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cs_usercmd_proto_rawDesc), len(file_cs_usercmd_proto_rawDesc)))
	})
...
func file_cs_usercmd_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cs_usercmd_proto_rawDesc), len(file_cs_usercmd_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
