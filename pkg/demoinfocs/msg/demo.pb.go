...
const file_demo_proto_rawDesc = "" +
	...
	"\x11server_start_tick\x18\x0f \x01(\x05R\x0fserverStartTick\"\xec\x06\n" +
	"\tCGameInfo\x12,\n" +
	"\x04dota\x18\x04 \x01(\v2\x18.CGameInfo.CDotaGameInfoR\x04dota\x12&\n" +
	"\x02cs\x18\x05 \x01(\v2\x16.CGameInfo.CCSGameInfoR\x02cs\x1a\xcd\x05\n" +
	...
	"gameWinner\x12E\n" +
	"\vplayer_info\x18\x04 \x03(\v2$.CGameInfo.CDotaGameInfo.CPlayerInfoR\n" +
	"playerInfo\x12\x1a\n" +
	"\bleagueid\x18\x05 \x01(\rR\bleagueid\x12H\n" +
	"\n" +
	"picks_bans\x18\x06 \x03(\v2).CGameInfo.CDotaGameInfo.CHeroSelectEventR\tpicksBans\x12&\n" +
	...
	"\vCCSGameInfo\x12*\n" +
	"\x11round_start_ticks\x18\x01 \x03(\x05R\x0froundStartTicks\"\xad\x01\n" +
	"\rCDemoFileInfo\x12#\n" +
	...
	"\tgame_info\x18\x04 \x01(\v2\n" +
	".CGameInfoR\bgameInfo\"!\n" +
	"\vCDemoPacket\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\"n\n" +
	"\x0fCDemoFullPacket\x125\n" +
	"\fstring_table\x18\x01 \x01(\v2\x12.CDemoStringTablesR\vstringTable\x12$\n" +
	"\x06packet\x18\x02 \x01(\v2\f.CDemoPacketR\x06packet\"v\n" +
	...
	"\aclasses\x18\x01 \x03(\v2\x17.CDemoClassInfo.class_tR\aclasses\x1af\n" +
	"\aclass_t\x12\x19\n" +
	...
	"\rdata_checksum\x18\x05 \x01(\x03R\fdataChecksum\"\xbd\x02\n" +
	"\x11CDemoStringTables\x122\n" +
	"\x06tables\x18\x01 \x03(\v2\x1a.CDemoStringTables.table_tR\x06tables\x1a/\n" +
	"\aitems_t\x12\x10\n" +
	"\x03str\x18\x01 \x01(\tR\x03str\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x1a\xc2\x01\n" +
	"\atable_t\x12\x1d\n" +
	"\n" +
	"table_name\x18\x01 \x01(\tR\ttableName\x120\n" +
	"\x05items\x18\x02 \x03(\v2\x1a.CDemoStringTables.items_tR\x05items\x12E\n" +
	"\x10items_clientside\x18\x03 \x03(\v2\x1a.CDemoStringTables.items_tR\x0fitemsClientside\x12\x1f\n" +
	...
	"\x04data\x18\x01 \x01(\fR\x04data\"\x85\x02\n" +
	"\rCDemoRecovery\x12Y\n" +
	"\x13initial_spawn_group\x18\x01 \x01(\v2).CDemoRecovery.DemoInitialSpawnGroupEntryR\x11initialSpawnGroup\x12.\n" +
