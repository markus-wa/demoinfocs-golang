...
type CMsgPlayerBulletHit struct {
	...
	ThroughSmoke     *bool                  `protobuf:"varint,8,opt,name=through_smoke,json=throughSmoke" json:"through_smoke,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CMsgPlayerBulletHit) GetThroughSmoke() bool {
	if x != nil && x.ThroughSmoke != nil {
...
const file_cs_gameevents_proto_rawDesc = "" +
	...
	"\x04type\x18\b \x01(\x05R\x04type\"\xaf\x02\n" +
	...
	"\ais_kill\x18\a \x01(\bR\x06isKill\x12#\n" +
	"\rthrough_smoke\x18\b \x01(\bR\fthroughSmoke*x\n" +
