...
func (*CCSUsrMsg_CustomHudClicked) Descriptor() ([]byte, []int) {
	return file_cstrike15_usermessages_proto_rawDescGZIP(), []int{74}
}
...
func (*CVacNet_GetReviewerInfo_Request) Descriptor() ([]byte, []int) {
	return file_cstrike15_usermessages_proto_rawDescGZIP(), []int{75}
}
...
func (*CVacnetReviewerInfo) Descriptor() ([]byte, []int) {
	return file_cstrike15_usermessages_proto_rawDescGZIP(), []int{76}
}
...
func (*CVacNet_GetReviewerInfo_Response) Descriptor() ([]byte, []int) {
	return file_cstrike15_usermessages_proto_rawDescGZIP(), []int{77}
}
...
func (x *CCSUsrMsg_RoundEndReportData_RerEvent_Victim) Reset() {
	*x = CCSUsrMsg_RoundEndReportData_RerEvent_Victim{}
	mi := &file_cstrike15_usermessages_proto_msgTypes[90]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CCSUsrMsg_RoundEndReportData_RerEvent_Objective) Reset() {
	*x = CCSUsrMsg_RoundEndReportData_RerEvent_Objective{}
	mi := &file_cstrike15_usermessages_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CCSUsrMsg_RoundEndReportData_RerEvent_Damage) Reset() {
	*x = CCSUsrMsg_RoundEndReportData_RerEvent_Damage{}
	mi := &file_cstrike15_usermessages_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CCSUsrMsg_SendPlayerLoadout_LoadoutItem) Reset() {
	*x = CCSUsrMsg_SendPlayerLoadout_LoadoutItem{}
	mi := &file_cstrike15_usermessages_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_cstrike15_usermessages_proto_rawDesc = "" +
	...
	" CVacNet_GetReviewerInfo_Response\x129\n" +
	"\rreviewer_info\x18\x01 \x01(\v2\x14.CVacnetReviewerInfoR\freviewerInfo*\xb6\x10\n" +
...
var file_cstrike15_usermessages_proto_msgTypes = make([]protoimpl.MessageInfo, 94)
var file_cstrike15_usermessages_proto_goTypes = []any{
	...
	(*CCSUsrMsg_CustomHudClicked)(nil),                               // 76: CCSUsrMsg_CustomHudClicked
	(*CVacNet_GetReviewerInfo_Request)(nil),                          // 77: CVacNet_GetReviewerInfo_Request
	(*CVacnetReviewerInfo)(nil),                                      // 78: CVacnetReviewerInfo
	(*CVacNet_GetReviewerInfo_Response)(nil),                         // 79: CVacNet_GetReviewerInfo_Response
	(*CCSUsrMsg_VGUIMenu_Keys)(nil),                                  // 80: CCSUsrMsg_VGUIMenu.Keys
	(*CCSUsrMsg_VoiceMask_PlayerMask)(nil),                           // 81: CCSUsrMsg_VoiceMask.PlayerMask
	(*CCSUsrMsg_ProcessSpottedEntityUpdate_SpottedEntityUpdate)(nil), // 82: CCSUsrMsg_ProcessSpottedEntityUpdate.SpottedEntityUpdate
	(*CCSUsrMsg_PlayerStatsUpdate_Stat)(nil),                         // 83: CCSUsrMsg_PlayerStatsUpdate.Stat
	(*CCSUsrMsg_ServerRankUpdate_RankUpdate)(nil),                    // 84: CCSUsrMsg_ServerRankUpdate.RankUpdate
	(*CCSUsrMsg_SurvivalStats_Fact)(nil),                             // 85: CCSUsrMsg_SurvivalStats.Fact
	(*CCSUsrMsg_SurvivalStats_Placement)(nil),                        // 86: CCSUsrMsg_SurvivalStats.Placement
	(*CCSUsrMsg_SurvivalStats_Damage)(nil),                           // 87: CCSUsrMsg_SurvivalStats.Damage
	(*CCSUsrMsg_EndOfMatchAllPlayersData_Accolade)(nil),              // 88: CCSUsrMsg_EndOfMatchAllPlayersData.Accolade
	(*CCSUsrMsg_EndOfMatchAllPlayersData_PlayerData)(nil),            // 89: CCSUsrMsg_EndOfMatchAllPlayersData.PlayerData
	(*CCSUsrMsg_RoundEndReportData_RerEvent)(nil),                    // 90: CCSUsrMsg_RoundEndReportData.RerEvent
	(*CCSUsrMsg_RoundEndReportData_InitialConditions)(nil),           // 91: CCSUsrMsg_RoundEndReportData.InitialConditions
	(*CCSUsrMsg_RoundEndReportData_RerEvent_Victim)(nil),             // 92: CCSUsrMsg_RoundEndReportData.RerEvent.Victim
	(*CCSUsrMsg_RoundEndReportData_RerEvent_Objective)(nil),          // 93: CCSUsrMsg_RoundEndReportData.RerEvent.Objective
	(*CCSUsrMsg_RoundEndReportData_RerEvent_Damage)(nil),             // 94: CCSUsrMsg_RoundEndReportData.RerEvent.Damage
	(*CCSUsrMsg_SendPlayerLoadout_LoadoutItem)(nil),                  // 95: CCSUsrMsg_SendPlayerLoadout.LoadoutItem
	(*CMsgVector2D)(nil),                                             // 96: CMsgVector2D
	(*CMsgRGBA)(nil),                                                 // 97: CMsgRGBA
	(*CMsgVector)(nil),                                               // 98: CMsgVector
	(*CEconItemPreviewDataBlock)(nil),                                // 99: CEconItemPreviewDataBlock
	(*ScoreLeaderboardData)(nil),                                     // 100: ScoreLeaderboardData
	(*PlayerDecalDigitalSignature)(nil),                              // 101: PlayerDecalDigitalSignature
	(*CMsgGCCstrike15V2_GC2ServerNotifyXPRewarded)(nil),              // 102: CMsgGCCstrike15_v2_GC2ServerNotifyXPRewarded
	(*CMsgGCCStrike15_ClientDeepStats)(nil),                          // 103: CMsgGCCStrike15_ClientDeepStats
	(*CMsgTransform)(nil),                                            // 104: CMsgTransform
	(*CMsgQAngle)(nil),                                               // 105: CMsgQAngle
	(*CMsgGCCStrike15V2_MatchmakingGC2ServerReserve)(nil),            // 106: CMsgGCCStrike15_v2_MatchmakingGC2ServerReserve
}
var file_cstrike15_usermessages_proto_depIdxs = []int32{
	80,  // 0: CCSUsrMsg_VGUIMenu.keys:type_name -> CCSUsrMsg_VGUIMenu.Keys
	96,  // 1: CCSUsrMsg_HudMsg.pos:type_name -> CMsgVector2D
	97,  // 2: CCSUsrMsg_HudMsg.clr1:type_name -> CMsgRGBA
	97,  // 3: CCSUsrMsg_HudMsg.clr2:type_name -> CMsgRGBA
	97,  // 4: CCSUsrMsg_Fade.clr:type_name -> CMsgRGBA
	81,  // 5: CCSUsrMsg_VoiceMask.player_masks:type_name -> CCSUsrMsg_VoiceMask.PlayerMask
	98,  // 6: CCSUsrMsg_Damage.inflictor_world_pos:type_name -> CMsgVector
	82,  // 7: CCSUsrMsg_ProcessSpottedEntityUpdate.entity_updates:type_name -> CCSUsrMsg_ProcessSpottedEntityUpdate.SpottedEntityUpdate
	99,  // 8: CCSUsrMsg_SendPlayerItemDrops.entity_updates:type_name -> CEconItemPreviewDataBlock
	99,  // 9: CCSUsrMsg_SendPlayerItemFound.iteminfo:type_name -> CEconItemPreviewDataBlock
	83,  // 10: CCSUsrMsg_PlayerStatsUpdate.stats:type_name -> CCSUsrMsg_PlayerStatsUpdate.Stat
	100, // 11: CCSUsrMsg_ScoreLeaderboardData.data:type_name -> ScoreLeaderboardData
	101, // 12: CCSUsrMsg_PlayerDecalDigitalSignature.data:type_name -> PlayerDecalDigitalSignature
	84,  // 13: CCSUsrMsg_ServerRankUpdate.rank_update:type_name -> CCSUsrMsg_ServerRankUpdate.RankUpdate
	102, // 14: CCSUsrMsg_XpUpdate.data:type_name -> CMsgGCCstrike15_v2_GC2ServerNotifyXPRewarded
	85,  // 15: CCSUsrMsg_SurvivalStats.facts:type_name -> CCSUsrMsg_SurvivalStats.Fact
	86,  // 16: CCSUsrMsg_SurvivalStats.users:type_name -> CCSUsrMsg_SurvivalStats.Placement
	87,  // 17: CCSUsrMsg_SurvivalStats.damages:type_name -> CCSUsrMsg_SurvivalStats.Damage
	89,  // 18: CCSUsrMsg_EndOfMatchAllPlayersData.allplayerdata:type_name -> CCSUsrMsg_EndOfMatchAllPlayersData.PlayerData
	91,  // 19: CCSUsrMsg_RoundEndReportData.init_conditions:type_name -> CCSUsrMsg_RoundEndReportData.InitialConditions
	90,  // 20: CCSUsrMsg_RoundEndReportData.all_rer_event_data:type_name -> CCSUsrMsg_RoundEndReportData.RerEvent
	103, // 21: CCSUsrMsg_DeepStats.stats:type_name -> CMsgGCCStrike15_ClientDeepStats
	104, // 22: CCSUsrMsg_ShootInfo.hitbox_transforms:type_name -> CMsgTransform
	98,  // 23: CCSUsrMsg_ShootInfo.shoot_pos:type_name -> CMsgVector
	105, // 24: CCSUsrMsg_ShootInfo.shoot_dir:type_name -> CMsgQAngle
	106, // 25: CCSUsrMsg_ServerRankRevealAll.reservation:type_name -> CMsgGCCStrike15_v2_MatchmakingGC2ServerReserve
	98,  // 26: CCSUsrMsg_DamagePrediction.shoot_pos:type_name -> CMsgVector
	105, // 27: CCSUsrMsg_DamagePrediction.shoot_dir:type_name -> CMsgQAngle
	105, // 28: CCSUsrMsg_DamagePrediction.aim_punch:type_name -> CMsgQAngle
	95,  // 29: CCSUsrMsg_SendPlayerLoadout.loadout:type_name -> CCSUsrMsg_SendPlayerLoadout.LoadoutItem
	78,  // 30: CVacNet_GetReviewerInfo_Response.reviewer_info:type_name -> CVacnetReviewerInfo
	88,  // 31: CCSUsrMsg_EndOfMatchAllPlayersData.PlayerData.nomination:type_name -> CCSUsrMsg_EndOfMatchAllPlayersData.Accolade
	99,  // 32: CCSUsrMsg_EndOfMatchAllPlayersData.PlayerData.items:type_name -> CEconItemPreviewDataBlock
	92,  // 33: CCSUsrMsg_RoundEndReportData.RerEvent.victim_data:type_name -> CCSUsrMsg_RoundEndReportData.RerEvent.Victim
	93,  // 34: CCSUsrMsg_RoundEndReportData.RerEvent.objective_data:type_name -> CCSUsrMsg_RoundEndReportData.RerEvent.Objective
	94,  // 35: CCSUsrMsg_RoundEndReportData.RerEvent.all_damage_data:type_name -> CCSUsrMsg_RoundEndReportData.RerEvent.Damage
	99,  // 36: CCSUsrMsg_SendPlayerLoadout.LoadoutItem.econ_item:type_name -> CEconItemPreviewDataBlock
