...
const file_usercmd_proto_rawDesc = "" +
	"\n" +
	"\rusercmd.proto\x1a\x15valveextensions.proto\x1a\x16networkbasetypes.proto\"\x84\x01\n" +
	...
	"\x0eignored_reason\x18\x01 \x01(\tR\rignoredReason:\x04\xc0\xe4\x1d\x01\"\xa5\x06\n" +
	...
	"clientTick\x12?\n" +
	"\x1cprediction_offset_ticks_x256\x18\x11 \x01(\rR\x19predictionOffsetTicksX256\x120\n" +
	"\n" +
	"buttons_pb\x18\x03 \x01(\v2\x11.CInButtonStatePBR\tbuttonsPb\x12+\n" +
	"\n" +
	"viewangles\x18\x04 \x01(\v2\v.CMsgQAngleR\n" +
	"viewangles\x12 \n" +
	...
	"\x12pawn_entity_handle\x18\x0e \x01(\r:\b16777215R\x10pawnEntityHandle\x126\n" +
	"\rsubtick_moves\x18\x12 \x03(\v2\x11.CSubtickMoveStepR\fsubtickMoves\x12\x19\n" +
	...
	"\tcmd_flags\x18\x15 \x01(\x05R\bcmdFlags\x12D\n" +
	"\x0fexecution_notes\x18\x16 \x01(\v2\x1b.CBaseUserCmdExecutionNotesR\x0eexecutionNotes:\x04\xc0\xe4\x1d\x01\";\n" +
	"\x0eCUserCmdBasePB\x12#\n" +
	"\x04base\x18\x01 \x01(\v2\x0f.CBaseUserCmdPBR\x04base:\x04\xc0\xe4\x1d\x01"
...
var file_usercmd_proto_goTypes = []any{
	...
	(*CBaseUserCmdExecutionNotes)(nil), // 2: CBaseUserCmdExecutionNotes
	(*CBaseUserCmdPB)(nil),             // 3: CBaseUserCmdPB
	(*CUserCmdBasePB)(nil),             // 4: CUserCmdBasePB
	(*CMsgQAngle)(nil),                 // 5: CMsgQAngle
}
var file_usercmd_proto_depIdxs = []int32{
	0, // 0: CBaseUserCmdPB.buttons_pb:type_name -> CInButtonStatePB
	5, // 1: CBaseUserCmdPB.viewangles:type_name -> CMsgQAngle
	1, // 2: CBaseUserCmdPB.subtick_moves:type_name -> CSubtickMoveStep
	2, // 3: CBaseUserCmdPB.execution_notes:type_name -> CBaseUserCmdExecutionNotes
	3, // 4: CUserCmdBasePB.base:type_name -> CBaseUserCmdPB
