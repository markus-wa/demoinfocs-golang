...
const file_gameevents_proto_rawDesc = "" +
	...
	"\rgamesessionid\x18\x02 \x01(\tR\rgamesessionid\"\xd6\x04\n" +
	"\x13CMsgPlaceDecalEvent\x12'\n" +
	"\bposition\x18\x01 \x01(\v2\v.CMsgVectorR\bposition\x12#\n" +
	"\x06normal\x18\x02 \x01(\v2\v.CMsgVectorR\x06normal\x12!\n" +
	"\x05saxis\x18\x03 \x01(\v2\v.CMsgVectorR\x05saxis\x12\x1c\n" +
	...
	"materialId\x12#\n" +
	"\rsequence_name\x18\f \x01(\rR\fsequenceName\x12>\n" +
	"\x14position_objectspace\x18\x0e \x01(\v2\v.CMsgVectorR\x13positionObjectspace\x12:\n" +
	"\x12normal_objectspace\x18\x0f \x01(\v2\v.CMsgVectorR\x11normalObjectspace\"?\n" +
	...
	"\fentityhandle\x18\x02 \x01(\r:\b16777215R\fentityhandle\"\xa2\x02\n" +
	"\x1eCMsgSource1LegacyGameEventList\x12N\n" +
	"\vdescriptors\x18\x01 \x03(\v2,.CMsgSource1LegacyGameEventList.descriptor_tR\vdescriptors\x1a/\n" +
	"\x05key_t\x12\x12\n" +
	...
	"\x04keys\x18\x03 \x03(\v2%.CMsgSource1LegacyGameEventList.key_tR\x04keys:\x06\x80\xb5\x18\x80\x80\x02\"g\n" +
	"\x1dCMsgSource1LegacyListenEvents\x12\x1e\n" +
	"\n" +
	"playerslot\x18\x01 \x01(\x05R\n" +
	"playerslot\x12&\n" +
	"\x0eeventarraybits\x18\x02 \x03(\rR\x0eeventarraybits\"\xb6\x03\n" +
	"\x1aCMsgSource1LegacyGameEvent\x12\x1d\n" +
	"\n" +
	"event_name\x18\x01 \x01(\tR\teventName\x12\x18\n" +
	"\aeventid\x18\x02 \x01(\x05R\aeventid\x125\n" +
	"\x04keys\x18\x03 \x03(\v2!.CMsgSource1LegacyGameEvent.key_tR\x04keys\x12\x1f\n" +
	...
	"\tspeed_out\x18\x06 \x01(\x02R\bspeedOut\"\xdf\x01\n" +
	...
	"\x04tags\x18\x05 \x01(\tR\x04tags\x12\x1d\n" +
	"\x03pte\x18\x06 \x01(\v2\v.CMsgVectorR\x03pte*\xea\x03\n" +
...
var file_gameevents_proto_goTypes = []any{
	...
	(*CMsgClothStiffenAnimEvent)(nil),                 // 14: CMsgClothStiffenAnimEvent
	(*CMsgClothEffectAnimEvent)(nil),                  // 15: CMsgClothEffectAnimEvent
	(*CMsgSource1LegacyGameEventListKeyT)(nil),        // 16: CMsgSource1LegacyGameEventList.key_t
	(*CMsgSource1LegacyGameEventListDescriptorT)(nil), // 17: CMsgSource1LegacyGameEventList.descriptor_t
	(*CMsgSource1LegacyGameEventKeyT)(nil),            // 18: CMsgSource1LegacyGameEvent.key_t
	(*CMsgVector)(nil),                                // 19: CMsgVector
}
var file_gameevents_proto_depIdxs = []int32{
	19, // 0: CMsgPlaceDecalEvent.position:type_name -> CMsgVector
	19, // 1: CMsgPlaceDecalEvent.normal:type_name -> CMsgVector
	19, // 2: CMsgPlaceDecalEvent.saxis:type_name -> CMsgVector
	19, // 3: CMsgPlaceDecalEvent.position_objectspace:type_name -> CMsgVector
	19, // 4: CMsgPlaceDecalEvent.normal_objectspace:type_name -> CMsgVector
	17, // 5: CMsgSource1LegacyGameEventList.descriptors:type_name -> CMsgSource1LegacyGameEventList.descriptor_t
	18, // 6: CMsgSource1LegacyGameEvent.keys:type_name -> CMsgSource1LegacyGameEvent.key_t
	19, // 7: CMsgClothEffectAnimEvent.pte:type_name -> CMsgVector
	16, // 8: CMsgSource1LegacyGameEventList.descriptor_t.keys:type_name -> CMsgSource1LegacyGameEventList.key_t
