...
const file_s2_cstrike15_gcmessages_proto_rawDesc = "" +
	...
	"serverinfo\x12x\n" +
	"\x14match_end_quest_data\x18\x04 \x01(\v2G.com.github.markus_wa.demoinfocs_golang.s2.CMsgGC_ServerQuestUpdateDataR\x11matchEndQuestData\"\xea\t\n" +
	...
	"\apattern\x18\n" +
	" \x01(\rR\apattern\x12%\n" +
	"\x0ehighlight_reel\x18\v \x01(\rR\rhighlightReel\"\x96\x01\n" +
