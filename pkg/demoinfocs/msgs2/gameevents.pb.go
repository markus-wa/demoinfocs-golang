...
type CMsgPlaceDecalEvent struct {
	...
	NormalObjectspace   *CMsgVector            `protobuf:"bytes,15,opt,name=normal_objectspace,json=normalObjectspace" json:"normal_objectspace,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CMsgPlaceDecalEvent) GetNormalObjectspace() *CMsgVector {
	if x != nil {
		return x.NormalObjectspace
	}
	return nil
}
...
type CMsgClothStiffenAnimEvent struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	SourceEntityIndex *int32                 `protobuf:"varint,1,opt,name=source_entity_index,json=sourceEntityIndex,def=-1" json:"source_entity_index,omitempty"`
...
// Default values for CMsgClothStiffenAnimEvent fields.
const (
	Default_CMsgClothStiffenAnimEvent_SourceEntityIndex = int32(-1)
)
...
func (*CMsgClothStiffenAnimEvent) Descriptor() ([]byte, []int) {
	return file_s2_gameevents_proto_rawDescGZIP(), []int{13}
}
...
func (x *CMsgClothStiffenAnimEvent) GetSourceEntityIndex() int32 {
	...
	return Default_CMsgClothStiffenAnimEvent_SourceEntityIndex
}
...
// Default values for CMsgClothEffectAnimEvent fields.
const (
	Default_CMsgClothEffectAnimEvent_SourceEntityIndex = int32(-1)
)
...
func (*CMsgClothEffectAnimEvent) Descriptor() ([]byte, []int) {
	return file_s2_gameevents_proto_rawDescGZIP(), []int{14}
}
...
func (x *CMsgClothEffectAnimEvent) GetSourceEntityIndex() int32 {
	...
	return Default_CMsgClothEffectAnimEvent_SourceEntityIndex
}
...
func (x *CMsgSource1LegacyGameEventListDescriptorT) Reset() {
	*x = CMsgSource1LegacyGameEventListDescriptorT{}
	mi := &file_s2_gameevents_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CMsgSource1LegacyGameEventKeyT) Reset() {
	*x = CMsgSource1LegacyGameEventKeyT{}
	mi := &file_s2_gameevents_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_s2_gameevents_proto_rawDesc = "" +
	...
	"\rgamesessionid\x18\x02 \x01(\tR\rgamesessionid\"\xa8\x06\n" +
	...
	"materialId\x12#\n" +
	"\rsequence_name\x18\f \x01(\rR\fsequenceName\x12h\n" +
	"\x14position_objectspace\x18\x0e \x01(\v25.com.github.markus_wa.demoinfocs_golang.s2.CMsgVectorR\x13positionObjectspace\x12d\n" +
	"\x12normal_objectspace\x18\x0f \x01(\v25.com.github.markus_wa.demoinfocs_golang.s2.CMsgVectorR\x11normalObjectspace\"?\n" +
	...
	"\x04keys\x18\x03 \x03(\v2O.com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.key_tR\x04keys:\x06\x80\xb5\x18\x80\x80\x02\"g\n" +
	...
	"\rpacked_fields\x18\x05 \x01(\fR\fpackedFields\"\xe5\x01\n" +
	"\x19CMsgClothStiffenAnimEvent\x122\n" +
	"\x13source_entity_index\x18\x01 \x01(\x05:\x02-1R\x11sourceEntityIndex\x12&\n" +
	...
	"\tspeed_out\x18\x06 \x01(\x02R\bspeedOut\"\x89\x02\n" +
	"\x18CMsgClothEffectAnimEvent\x122\n" +
	"\x13source_entity_index\x18\x01 \x01(\x05:\x02-1R\x11sourceEntityIndex\x12(\n" +
	...
	"\x04tags\x18\x05 \x01(\tR\x04tags\x12G\n" +
	"\x03pte\x18\x06 \x01(\v25.com.github.markus_wa.demoinfocs_golang.s2.CMsgVectorR\x03pte*\xea\x03\n" +
...
var file_s2_gameevents_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_s2_gameevents_proto_goTypes = []any{
	...
	(*CMsgClothStiffenAnimEvent)(nil),                 // 14: com.github.markus_wa.demoinfocs_golang.s2.CMsgClothStiffenAnimEvent
	(*CMsgClothEffectAnimEvent)(nil),                  // 15: com.github.markus_wa.demoinfocs_golang.s2.CMsgClothEffectAnimEvent
	(*CMsgSource1LegacyGameEventListKeyT)(nil),        // 16: com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.key_t
	(*CMsgSource1LegacyGameEventListDescriptorT)(nil), // 17: com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.descriptor_t
	(*CMsgSource1LegacyGameEventKeyT)(nil),            // 18: com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEvent.key_t
	(*CMsgVector)(nil),                                // 19: com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
}
var file_s2_gameevents_proto_depIdxs = []int32{
	19, // 0: com.github.markus_wa.demoinfocs_golang.s2.CMsgPlaceDecalEvent.position:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
	19, // 1: com.github.markus_wa.demoinfocs_golang.s2.CMsgPlaceDecalEvent.normal:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
	19, // 2: com.github.markus_wa.demoinfocs_golang.s2.CMsgPlaceDecalEvent.saxis:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
	19, // 3: com.github.markus_wa.demoinfocs_golang.s2.CMsgPlaceDecalEvent.position_objectspace:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
	19, // 4: com.github.markus_wa.demoinfocs_golang.s2.CMsgPlaceDecalEvent.normal_objectspace:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
	17, // 5: com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.descriptors:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.descriptor_t
	18, // 6: com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEvent.keys:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEvent.key_t
	19, // 7: com.github.markus_wa.demoinfocs_golang.s2.CMsgClothEffectAnimEvent.pte:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgVector
	16, // 8: com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.descriptor_t.keys:type_name -> com.github.markus_wa.demoinfocs_golang.s2.CMsgSource1LegacyGameEventList.key_t
