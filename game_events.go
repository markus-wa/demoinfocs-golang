...
func newGameEventHandler(parser *Parser) gameEventHandler {
	...
	geh.gameEventNameToHandler = map[string]gameEventHandlerFunc{
		...
		"flashbang_detonate":              delay(geh.flashBangDetonate), // Flash exploded. Delayed because FlashDuration is not yet available
		...
		"player_blind":                    delay(geh.playerBlind),       // Player got blinded by a flash
